...
const GameControls = ({ onControl, sensitivity }: GameControlsProps) => {
  ...
  const btnStyle = (bg: string, shadow: string) => ({
    width: size,
    height: size,
    borderRadius: "50%",
    background: bg,
  ...
  return (
    <>
      ...
      >
        <button
          className={btnBase}
          style={btnStyle("linear-gradient(135deg, #00cc66, #00aa55)", "rgba(0,200,100,0.4)")}
        ...
        <button
          className={btnBase}
          style={btnStyle("linear-gradient(135deg, #ff4444, #cc2222)", "rgba(255,50,50,0.4)")}
      ...
      {/* RIGHT SIDE: Left & Right arrow buttons */}
      <div
      ...
      >
        <button
          className={btnBase}
          style={btnStyle("linear-gradient(135deg, #4488ff, #2266dd)", "rgba(68,136,255,0.4)")}
        ...
        <button
          className={btnBase}
          style={btnStyle("linear-gradient(135deg, #ffaa00, #dd8800)", "rgba(255,170,0,0.4)")}
