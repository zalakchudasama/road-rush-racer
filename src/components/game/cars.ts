...
export const CARS: CarData[] = [
  ...
  { id: "nano", name: "Tata Nano", emoji: "🚗", price: 500, color1: "#44dd44", color2: "#22aa22", color3: "#116611", speed: 0, description: "Small & quick" },
  { id: "swift", name: "Maruti Swift", emoji: "🚙", price: 1200, color1: "#4488ff", color2: "#2266cc", color3: "#114488", speed: 1, description: "Smooth handler" },
  { id: "fortuner", name: "Toyota Fortuner", emoji: "🚐", price: 2500, color1: "#ffffff", color2: "#cccccc", color3: "#888888", speed: 1, description: "Big & powerful" },
  { id: "scorpio", name: "Mahindra Scorpio", emoji: "🛻", price: 3000, color1: "#111111", color2: "#333333", color3: "#000000", speed: 2, description: "Beast on road" },
  { id: "mustang", name: "Ford Mustang", emoji: "🐎", price: 5000, color1: "#ffcc00", color2: "#ddaa00", color3: "#aa7700", speed: 2, description: "American muscle" },
  { id: "lambo", name: "Lamborghini", emoji: "🏁", price: 10000, color1: "#ff6600", color2: "#dd4400", color3: "#aa2200", speed: 3, description: "Ultimate speed" },
];
